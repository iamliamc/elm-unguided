									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(_p2.label),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(_p2.age)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		_user$project$Main$instruments(_p2.instruments)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
		...
		case 'DisplayComments':
			...
			return A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: header(
						A2(_elm_lang$core$Basics_ops['++'], 'Comments for ', _p3.name)),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										_user$project$Main$viewComments(_p3.comments)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$viewAddComment, model, _p3),
							_1: {ctor: '[]'}
						}
					}
				});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(song.description),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(song.key),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(song.tempo)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Main$viewSongTable = function (songs) {
	return A2(
		_elm_lang$html$Html$table,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$tbody,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Main$viewSong, songs)),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Song Catalog!'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.DisplayState":{"args":[],"tags":{"DisplayNone":[],"DisplayComments":["Main.Song"],"DisplayArtist":["Main.Artist"]}},"Main.Msg":{"args":[],"tags":{"SetCommentUsername":["String"],"ShowCommentDetails":["Main.DisplayState"],"SetCommentContent":["String"],"SaveComment":["Main.Song"],"CancelComment":[],"ShowArtistDetails":["Main.DisplayState"],"DoNothing":[]}}},"aliases":{"Main.Instrument":{"args":[],"type":"{ name : String, origin : String, age : Int, picture : String }"},"Main.Song":{"args":[],"type":"{ name : String , description : String , key : String , tempo : Int , artist : Main.Artist , comments : List Main.Comment }"},"Main.Artist":{"args":[],"type":"{ name : String , label : String , age : Int , instruments : List Main.Instrument }"},"Main.Comment":{"args":[],"type":"{ user : String, content : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
